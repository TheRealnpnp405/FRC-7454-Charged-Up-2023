...
public class LEDz {
	...
	private LEDzPattern m_pattern;
	private Timer timer = new Timer();
	private TimerTask task;
	private int m_animationDelay = 50;

	public LEDz(int pwmPort, int length) {
		super();
	...
	public LEDz(int pwmPort, int length, int animationSpeed) {
		this(pwmPort, length);
	...
	public void setPattern(LEDzPattern pattern) {
