...
/** Add your docs here. */
public class Intensity  implements LEDzPattern {
	 ...
	 */
	public Intensity(Color highColor, double intensity){
		this(Color.kBlack,highColor,intensity);
	}

	public Intensity(Color lowColor, Color highColor, double intensity){
		super();
